	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Cursos-TÉCNICO LABORAL EN AUXILIAR DE EDUCACIÓN PARA LA PRIMERA INFANCIA | IETDH PORFIRIO BARBARA JACOB</title>
				...
				<div class="container">
					<div class="row">
						...
						<div class="main-image">
								<h3>TÉCNICO LABORAL EN AUXILIAR DE EDUCACIÓN PARA LA PRIMERA INFANCIA</h3>
							</div>
							<br>
							<div class="main-image">
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            ...
	                            <div class="jq-tab-content-wrapper">
									...
									El programa de 1128 horas, de las cuales el 47%  son teóricas y el 53% son prácticas.
	                                </div>
	                                <div class="jq-tab-content" data-tab="3">
									Prestan servicio de apoyo en actividades educativas bajo la supervisión de un educador infantil, orientadas a promover el desarrollo integral de las niñas y los niños. Se pueden desempeñar en modalidades de educación inicial, centros de desarrollo infantil, jardines infantiles, preescolares, guarderías, centros de estimulación, sala cunas, sala materna, hogares comunitarios, museos, bibliotecas, ludotecas, parques, entre otros.
	                                </div>
