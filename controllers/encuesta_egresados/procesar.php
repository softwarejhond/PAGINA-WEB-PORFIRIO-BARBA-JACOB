...
$lugar = ($trabaja == "si") ? $_POST['lugar_trabajo'] : null;
$cargo = ($trabaja == "si") ? $_POST['cargo'] : null;
$tipo_empresa = ($trabaja == "si") ? $_POST['tipo_empresa'] : null;
$tipo_contrato = ($trabaja == "si") ? $_POST['tipo_contrato'] : null;
$nivel = ($trabaja == "si") ? $_POST['nivel_salarial'] : null;

$continuo = $_POST['continuo'];
$donde_estudio = ($continuo == "si") ? $_POST['donde_estudio'] : null;
